...
sNext:"التالي",sPrevious:"السابق"},sEmptyTable:"No data available in table",sInfo:"إظهار _START_ إلى _END_ من _TOTAL_ من الإدخالات",sInfoEmpty:"إظهار 0 إلى 0 من 0 إدخالات",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"عرض _MENU_ إدخالات",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"بحث:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
